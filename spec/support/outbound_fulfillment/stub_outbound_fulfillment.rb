def stub_list_fulfillment_orders
  stub_request(:get, "https://#{hostname}/fba/outbound/2020-07-01/fulfillmentOrders")
    .to_return(status: 200, body: File.read("./spec/support/outbound_fulfillment/list_fulfillment_orders.json"), headers: {})
end
...
def stub_get_fulfillment_order(seller_fulfillment_order_id)
  stub_request(:get, "https://#{hostname}/fba/outbound/2020-07-01/fulfillmentOrders/#{seller_fulfillment_order_id}")
    .to_return(status: 200, body: File.read("./spec/support/outbound_fulfillment/get_fulfillment_order.json"), headers: {})
end

module MuffinMan
  module Solicitations
    class V1 < SpApiClient
      SANDBOX_AMAZON_ORDER_ID = "123-1234567-1234567".freeze
      ...
      # Send only one productReviewAndSellerFeedback or free form proactive message per order.  **Usage Plan:**
      # | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 |  For more information, see \"Usage Plans
      ...
      # @param marketplace_ids A marketplace identifier. This specifies the marketplace in which the order was placed.

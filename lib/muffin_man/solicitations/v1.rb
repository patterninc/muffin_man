...
module MuffinMan
  module Solicitations
    class V1 < SpApiClient
      ...
      # Sends a solicitation to a buyer asking for seller feedback and a product review for the specified order. Send only
      # one productReviewAndSellerFeedback or free form proactive message per order.
      ...
      # @param marketplace_ids A marketplace identifier. This specifies the marketplace in which the order was placed. Only
      # one marketplace can be specified.

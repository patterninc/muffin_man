module MuffinMan
  module MerchantFulfillment
    class V0 < SpApiClient
      ...
      def create_shipment(shipment_request_details, shipping_service_id, shipping_service_offering_id: nil, hazmat_type: nil, label_format_option: {}, shipment_level_seller_inputs_list: [])
        ...
        @request_body["ShipmentLevelSellerInputsList"] = shipment_level_seller_inputs_list if shipment_level_seller_inputs_list.any?
        @request_type = "POST"
        call_api
      end
